...
class TransferOrderTest1(unittest.TestCase):
    ...
    def test_basic1(self):
        ...
        self.assertEqual(
            self.broker_state1.accounts['EUR_CASH'],
    ...
    def test_basic2(self):
        ...
        self.assertEqual(
            self.broker_state1.accounts['USD_CASH'],
    ...
    def test_straight_vs_inverted(self):
        ...
        self.assertEqual(
            self.broker_state1.accounts['USD_CASH'],
            (10000.0 + 100 * 1.2 * self.spread, 'USD'),
        )
    ...
    def test_three_num_backward_transfer1(self):
        ...
        self.assertEqual(
            self.broker_state1.accounts['EUR_CASH'],
            (
                10000.0 - 1.0 / (self.prices[('USD', 'XAU')] * self.prices[('EUR', 'USD')]),
                'EUR',
            ),
        )
        self.assertEqual(
    ...
    def test_three_num_forward_transfer1(self):
        ...
        self.assertEqual(
            self.broker_state1.accounts['USD_CASH'],
            (
                10000.0 + self.prices[('EUR', 'USD')] / self.prices[('EUR', 'XAU')],
                'USD',
            ),
        )
        self.assertEqual(self.broker_state1.accounts['XAU_BARS'], (1.0, 'XAU'))
