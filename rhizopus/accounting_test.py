import unittest
from .accounting import find_path, calc_path_price
...
class TestUtils(unittest.TestCase):
    ...
    def test_path_price(self):
        ...
        self.assertAlmostEqual(calc_path_price(self.prices, 'XAU', 'EUR'),
                               self.prices[('XAU', 'USD')]*self.prices[('USD', 'EUR')])

        self.assertAlmostEqual(calc_path_price(self.prices, 'EUR', 'XAU'),
